...
public class L2ListElem extends PersistentResource {
  ...
  /**
   * Get next list element. Been call for the last list element, this method will return first
   * element of the list or list header
   */
  ...
  /**
   * Get previous list element. Been call for the first list element, this method will return last
   * element of the list or list header
   */
