...
public interface Blob extends IPersistent, IResource {
   ...
   * Get output stream to append data to the BLOB.
   * 
   * @param multisession whether BLOB allows further appends of data or closing this output streat
   *        means that BLOB will not be changed any more.
   * @return output srteam
   */
   ...
   * 
   * @param position current position in BLOB, if less than zero, than data will be appended to the
   *        BLOB
   * @param multisession whether BLOB allows further appends of data or closing this output streat
   *        means that BLOB will not be changed any more.
   * @return output srteam
   ...
   * Get output stream to append data to the BLOB.
   * 
   * @param flags bit mask of BLOB flags: ENABLE_SEGMENT_CACHING, DOUBLE_SEGMENT_SIZE,
   *        TRUNCATE_LAST_SEGMENT, APPEND
   * @return output srteam
   */
