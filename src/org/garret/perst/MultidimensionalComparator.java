...
public abstract class MultidimensionalComparator<T> extends Persistent {
   ...
   * @return LEFT_UNDEFINED if value of i-th component of m1 is null and value of i-th component of
   *         m2 is not null, RIGHT_UNDEFINED if value of i-th component of m1 is not null and value
   *         of i-th component of m2 is null, EQ if both values are null, otherwise LT, EQ or GT
