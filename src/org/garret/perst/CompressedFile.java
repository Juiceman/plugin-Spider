...
/**
 * Compressed read-only database file. You should create database using normal file (OSFile). Then
 * use CompressDatabase utility to compress database file. To work with compressed database file you
 * should pass instance of this class in <code>Storage.open</code> method
 */
