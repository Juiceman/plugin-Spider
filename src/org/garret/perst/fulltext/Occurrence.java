...
public class Occurrence implements Comparable {
  ...
  public int position;
  /**
   * Word occurrence kind. It is up to the document scanner implementation how to enumerate
   * occurence kinds. These is only one limitation - number of difference kinds should not exceed 8.
   */
  public int kind;
