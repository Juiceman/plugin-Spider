...
/**
 * Full text search index. This index split document text in words, perform stemming of the words
 * and build inverse index. Full text index is able to execute search queries with logical operators
 * (AND/OR/NOT) and strict match. Returned results are ordered by rank, which includes inverse
 * document frequency (IDF), frequency of word in the document, occurrence kind and nearness of
 * query keywords in the document text.
 */
