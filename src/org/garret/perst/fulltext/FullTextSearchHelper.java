...
/**
 * Helper class for full text search. This class provides functionality for parsing and stemming
  ...
  protected FullTextQuery term(QueryScanner scanner) {
    ...
    switch (scanner.scan()) {
      ...
      case QueryScanner.TKN_WORD:
        q = new FullTextQueryMatchOp(
            scanner.inQuotes ? FullTextQuery.STRICT_MATCH : FullTextQuery.MATCH, scanner.word,
            scanner.wordPos);
        break;
