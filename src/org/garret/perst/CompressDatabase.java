 ...
 * Then use this utiulity to compress database file. To work with compressed database file you
 * should path instance if this class in <code>Storage.open</code> method
 */
public class CompressDatabase {
  /**
   * This utility accepts one argument: path to database file. It creates new file at the same
   * location and with the same name but with with ".dbz" extension.
   */
  public static void main(String[] args) throws IOException {
    if (args.length == 0 || args.length > 2) {
      System.err.println(
          "Usage: java org.garret.perst.CompressDatabase DATABASE_FILE_PATH [COMPRESSION-LEVEL]");
      return;
    }
    String path = args[0];
