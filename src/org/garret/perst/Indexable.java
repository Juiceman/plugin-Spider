 ...
 * Indices can be unique or allow duplicates. If index is marked as unique and during transaction
 * commit it is find out that there is already some other object with this key, NotUniqueException
 * will be thrown Case insensitive attribute is meaningful only for string keys and if set cause
 * ignoring case of key values. Thick index should be used for keys with small set of unique values.
 */
