...
public class SqlOptimizerParameters {
  /**
   * If optimization is enabled SQL engine will choose order of query conjuncts execution based on
   * the estimation of their execution cost, if optimization is disable, then conjuncts will be
   * executed in the same order as them are specified in the query.
   */
  ...
  /**
   * Cost of searching using non-unique index. It is used only of equality comparisons and is added
   * to eqCost, eqStringConst...
   */
  ...
  /**
   * Cost of each extra level of indirection, for example in condition (x.y.z = 1) indirection level
   * is 2 and in condition (x = 2) it is 0.
   */
