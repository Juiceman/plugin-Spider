 ...
 */
public interface IPersistentMap<K extends Comparable, V>
    extends SortedMap<K, V>, IPersistent, IResource {
  /**
   * Get entry for the specified key. This method can be used to obtains both key and value. It is
   * needed when key is persistent object.
   * 
