...
/**
 * Interface of selectable collection. Selectable collections allows to selct its memebers using
 * JSQL query
 */
public interface ITable<T> extends Collection<T> {
   ...
   * check if there are some other references to the deallocated objects. If deallocated object is
   * included in some other index or is referenced from some other objects, then after deallocation
   * there will be dangling references and dereferencing them can cause unpredictable behavior of
   * the program.
   */
