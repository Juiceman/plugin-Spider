...
/**
 * Collection of version of versioned object. Versioned object should be access through version
 * history object. Instead of storing direct reference to Verson in some component of some other
 * persistent object, it is necessary to store reference to it's VersionHistory.
 */
public class VersionHistory<V extends Version> extends PersistentResource {
  /**
   * Get current version in version history. Current version can be explicitely set by setVersion or
   * result of last checkOut is used as current version
   */
  ...
  /**
   * Checkout current version: create successor of the current version. This version has to be
   * checked-in in order to be placed in version history
   * 
   ...
   * 
   * @param timestamp deadline, if <code>null</code> then the latest version in version history will
   *        be returned
   * @return version with the largest timestamp less than or equal to specified
   *         <code>timestamp</code>
   */
   ...
   * @return version with the smallest timestamp greater than or equal to specified
   *         <code>timestamp</code>
   */
  ...
  /**
   * Get version with specified label. If there are more than one version marked with this label,
   * then the latest one will be returned
   * 
  ...
  /**
   * Get iterator through all version in version history Iteration is started from the root version
   * and performed in direction of increaing version timestamp This iterator supports remove()
   * method.
   * 
