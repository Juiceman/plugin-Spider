...
/**
 * Class use to project selected objects using relation field. For all selected objects (specified
 * by array or iterator), value of specified field (of IPersistent, array of IPersistent, Link or
 * Relation type) is inspected and all referenced object for projection (duplicate values are
 * eliminated)
 */
public class Projection<From, To> extends HashSet<To> {
   ...
   * derive your class from Projection and redefine map method in it or specify type and fieldName
   * later using setProjectionField method
   */
  public Projection() {}
  ...
  /**
   * Get related objects for the object obj. It is possible to redifine this method in derived
   * classes to provide application specific mapping
   * 
