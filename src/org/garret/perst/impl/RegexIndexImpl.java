...
public class RegexIndexImpl<T> extends AltBtreeFieldIndex<T> implements RegexIndex<T> {
  ...
  public IterableIterator<T> match(String pattern) {
    ...
    } else if (firstWildcard == pattern.length() - 1 && pattern.charAt(firstWildcard) == '%') { // pattern
                                                                                                // like
                                                                                                // 'XYZ%':
                                                                                                // use
                                                                                                // prefix
    ...
    } else if (firstWildcard >= nGrams * 2 || firstWildcard > pattern.length() - nGrams) { // better
                                                                                           // to use
                                                                                           // prefix
                                                                                           // search
  ...
  List<String> splitPattern(String s) {
    ...
    forAllNGrams: for (int i = 0; i < n; i++) {
