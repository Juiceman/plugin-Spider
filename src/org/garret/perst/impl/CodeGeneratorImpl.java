...
class CodeGeneratorImpl implements CodeGenerator {
  ...
  public Code in(Code opd1, Code opd2) {
    ...
    switch (right.type) {
      ...
      case Node.tpArrayBool:
        return new BinOpNode(Node.tpBool, Node.opScanArrayBool, checkType(Node.tpBool, left),
            right);
      case Node.tpArrayInt1:
  ...
  public Code literal(Object value) {
    if (value instanceof Long || value instanceof Integer || value instanceof Short
      ...
      return new ConstantNode(Node.tpBool,
          ((Boolean) value).booleanValue() ? Node.opTrue : Node.opFalse);
