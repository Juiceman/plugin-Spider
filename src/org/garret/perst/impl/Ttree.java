...
public class Ttree<T> extends PersistentCollection<T> implements SortedCollection<T> {
   ...
   * @return <code>true</code> in case of success, <code>false</code> if there is no such key in the
   *         collection
   */
  @Override
  ...
  /**
   * Get all objects in the index as array ordered by index key. The runtime type of the returned
   * array is that of the specified array. If the index fits in the specified array, it is returned
