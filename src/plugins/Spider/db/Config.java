...
public class Config extends Persistent implements Cloneable {
  ...
  public Config(Storage storage) {
    ...
    badlistedExtensions = new String[] { //
        ...
        ".mpg", ".ogg", ".ogv", ".mp3", ".avi", ".wv", ".swf", ".wmv", ".mkv", ".flac", ".ogm",
        ".divx", ".mpeg", ".rm", ".wma", ".asf", ".rmvb", ".mov", ".flv", ".mp4", ".m4v", ".wav",
        ".aac", ".cda", ".fla", ".m4a", ".midi", ".vob", // media
        ".css", ".sig", ".gml", ".df", ".cbr", ".gf", ".pdf", ".db", ".dbf", ".accdb", ".dat",
        ".docx", ".dwg", ".mdf", ".odg", ".odt", ".ods", ".pps", ".wdb", ".xls", ".xlsx" // other
    };
  ...
  public synchronized int getMaxParallelRequests() {
    ...
    if (this.getBeginWorkingPeriod() < this.getEndWorkingPeriod()) {
      ...
      // 0 -----|############|----- 24
      isWorking =
          (actualHour > this.getBeginWorkingPeriod() && actualHour < this.getEndWorkingPeriod());
    } else {
